defmodule AdButler.Repo.Migrations.CreateAdInsights30dView do
  use Ecto.Migration

  def up do
    execute """
    CREATE MATERIALIZED VIEW ad_insights_30d AS
    SELECT
      ad_id,
    ...
    execute "CREATE UNIQUE INDEX ON ad_insights_30d (ad_id)"
  end

  def down do
    execute "DROP MATERIALIZED VIEW IF EXISTS ad_insights_30d"
  end
end
