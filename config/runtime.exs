...
#
#     PHX_SERVER=true bin/ad_butler start
#
  ...
  config :ad_butler, AdButler.Mailer,
    ...
    port:
      (case Integer.parse(System.get_env("SMTP_PORT", "587")) do
         {port, ""} -> port
         _ -> raise "SMTP_PORT must be a valid integer, got: #{System.get_env("SMTP_PORT")}"
       end),
    ...
    tls_options: [
      ...
      server_name_indication: System.fetch_env!("SMTP_HOST") |> String.to_charlist(),
      depth: 3
    ]
end
