defmodule AdButlerWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: AdButlerWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AdButlerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AdButlerWeb.Gettext, "errors", msg, opts)
    end
  end
